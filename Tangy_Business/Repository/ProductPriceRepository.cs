    ...
    public class ProductPriceRepository : IProductPriceRepository
    {
        ...
        public async Task<int> Delete(int id)
        {
            ...
            if (obj != null)
            {
                ...
                return _db.SaveChanges(); // returns how many changes happened. in this case it should be 1.
            }
            return 0; // If the delete method fails or does not delete it will return a 0.
        }
        ...
        public async Task<IEnumerable<ProductPriceDTO>> GetAll(int? id=null)
        {
            if(id!=null && id > 0)
            {
                return _mapper.Map<IEnumerable<ProductPrice>, IEnumerable<ProductPriceDTO>>
                    (_db.ProductPrices.Where(x => x.ProductId == id).Include(x=> x.Product.Category));
            }
            else
            {
